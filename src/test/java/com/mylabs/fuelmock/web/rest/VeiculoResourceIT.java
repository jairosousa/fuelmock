...
public class VeiculoResourceIT {
    ...
    private static final BigDecimal DEFAULT_KM = new BigDecimal(1);
    private static final BigDecimal UPDATED_KM = new BigDecimal(2);

    private static final BigDecimal DEFAULT_CAP_TANQUE = new BigDecimal(1);
    private static final BigDecimal UPDATED_CAP_TANQUE = new BigDecimal(2);
    ...
    public void createVeiculo() throws Exception {
        ...
        assertThat(testVeiculo.getKm()).isEqualTo(DEFAULT_KM);
        assertThat(testVeiculo.getCapTanque()).isEqualTo(DEFAULT_CAP_TANQUE);
    ...
    public void getAllVeiculos() throws Exception {
        ...
        restVeiculoMockMvc.perform(get("/api/veiculos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].capTanque").value(hasItem(DEFAULT_CAP_TANQUE.intValue())))
    ...
    public void getVeiculo() throws Exception {
        ...
        restVeiculoMockMvc.perform(get("/api/veiculos/{id}", veiculo.getId()))
            ...
            .andExpect(jsonPath("$.capTanque").value(DEFAULT_CAP_TANQUE.intValue()))
    ...
    public void updateVeiculo() throws Exception {
        ...
        assertThat(testVeiculo.getKm()).isEqualTo(UPDATED_KM);
        assertThat(testVeiculo.getCapTanque()).isEqualTo(UPDATED_CAP_TANQUE);
